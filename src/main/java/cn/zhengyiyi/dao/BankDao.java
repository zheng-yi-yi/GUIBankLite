...
import cn.zhengyiyi.common.tool.DatabaseTool;
...
public class BankDao {
    ...
    public Bank getBankByName(String bankName) {
        try {
            ...
            try (Connection conn = databaseTool.getConnection();
    ...
    public void deleteBankCard(String cardNumber) throws SQLException {
        ...
        String deleteTransactionsSql = "DELETE FROM accounts WHERE card_number = ?";
